describe('Wrap Parse', function() {
  var $rootScope, $compile, $timeout, Product, p, element, wrapParse;
  ...
  beforeEach(inject(function(_$rootScope_, _$compile_, _$timeout_, _wrapParse_) {
    $compile = _$compile_;
  ...
  describe('Parse.Object', function() {
    ...
    describe('parses the property to its type: ', function() {
